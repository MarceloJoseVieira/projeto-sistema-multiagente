...
class GameState:
    ...
    # Adicionado para MCTS: Verifica se o jogo terminou (algum jogador completou uma linha)
    ...
    # Adicionado para MCTS: Calcula os bônus finais do jogo
    def ExecuteEndOfGame(self):
        for plr in self.players:
            plr.EndOfGameScore()
